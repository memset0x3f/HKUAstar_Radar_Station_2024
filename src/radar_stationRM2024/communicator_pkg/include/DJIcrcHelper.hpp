...
#include <stdint.h>
#include <cstdlib>
inline const unsigned char CRC8_INIT=0xff;
inline const unsigned char CRC8_TAB[256] =
{
...
inline unsigned char Get_CRC8_Check_Sum(unsigned char *pchMessage, unsigned int dwLength, unsigned char ucCRC8)
{
 ...
 /*
 **Descriptions:CRC8Verifyfunction
 **Input:DatatoVerify,Streamlength=Data+checksum
 **Output:TrueorFalse(CRCVerifyResult)
 */
inline unsigned int Verify_CRC8_Check_Sum(unsigned char *pchMessage, unsigned int dwLength)
{
 ...
 /*
 **Descriptions:appendCRC8totheendofdata
 **Input:DatatoCRCandappend,Streamlength=Data+checksum
 **Output:TrueorFalse(CRCVerifyResult)
 */
...
inline uint16_t CRC_INIT=0xffff;
inline const uint16_t wCRC_Table[256] =
{
 ...
 /*
 **Descriptions:CRC16checksumfunction
 **Input:Datatocheck,Streamlength,initializedchecksum
 **Output:CRCchecksum
 */
inline uint16_t Get_CRC16_Check_Sum(uint8_t *pchMessage,uint32_t dwLength,uint16_t wCRC)
{
 ...
 /*
 **Descriptions:CRC16Verifyfunction
 **Input:DatatoVerify,Streamlength=Data+checksum
 **Output:TrueorFalse(CRCVerifyResult)
 */
inline uint32_t Verify_CRC16_Check_Sum(uint8_t *pchMessage, uint32_t dwLength)
{
 ...
 /*
 **Descriptions:appendCRC16totheendofdata
 **Input:DatatoCRCandappend,Streamlength=Data+checksum
 **Output:TrueorFalse(CRCVerifyResult)
 */
